package net.horizonsquarer.splanade.datagen.loot;
...
public class ModBlockLootTables extends BlockLootSubProvider {
    ...
    protected void generate() {
        this.dropSelf(ModBlocks.MYCOSTATIC_CRUST.get());
        this.dropSelf(ModBlocks.PETRIFIED_MYCOSTRATUM.get());
        this.dropSelf(ModBlocks.REFINED_TENEBRITE_BLOCK.get());
