...
public enum ModArmorMaterials implements ArmorMaterial {
    REFINED_TENEBRITE("refined_tenebrite", 47, new int[]{ 8, 14, 8, 7}, 25,
            SoundEvents.ARMOR_EQUIP_NETHERITE, 3f,  0.3f, () -> Ingredient.of(ModItems.REFINED_TENEBRITE.get()));
    ...
    public String getName() {
        return Splanade.MOD_ID + ":" + this.name;
    }
